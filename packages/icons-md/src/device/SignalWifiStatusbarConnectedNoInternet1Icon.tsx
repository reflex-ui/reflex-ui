...
let SignalWifiStatusbarConnectedNoInternet1Icon: React.ComponentType<
  RfxSvgPropsOptional
...
SignalWifiStatusbarConnectedNoInternet1Icon = processComponent<
  RfxSvgPropsOptional
>(SignalWifiStatusbarConnectedNoInternet1Icon, {
  name: 'SignalWifiStatusbarConnectedNoInternet1Icon',
});
export { SignalWifiStatusbarConnectedNoInternet1Icon };
