  ...
  color: {
    inverted: {
      ...
      uncontained: createPaletteColorInteraction({
        color: createPaletteColorUsingColorOnly(grey700),
    ...
    regular: {
      ...
      uncontained: createPaletteColorInteraction({
        color: createPaletteColorUsingOnColorOnly(grey700),
        colorVariantFactory: createUncontainedPaletteColorVariant,
