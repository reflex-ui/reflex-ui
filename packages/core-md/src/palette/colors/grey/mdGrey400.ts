  ...
  color: {
    inverted: {
      ...
      uncontained: createPaletteColorInteraction({
        color: createPaletteColorUsingOnColorOnly(grey400),
    ...
    regular: {
      ...
      uncontained: createPaletteColorInteraction({
        color: createPaletteColorUsingColorOnly(grey400),
        colorVariantFactory: createUncontainedPaletteColorVariant,
