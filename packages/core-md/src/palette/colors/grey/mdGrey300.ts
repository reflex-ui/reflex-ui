  ...
  color: {
    inverted: {
      ...
      uncontained: createPaletteColorInteraction({
        color: createPaletteColorUsingColorOnly(grey300),
    ...
    regular: {
      ...
      uncontained: createPaletteColorInteraction({
        color: createPaletteColorUsingOnColorOnly(grey300),
        colorVariantFactory: createUncontainedPaletteColorVariant,
