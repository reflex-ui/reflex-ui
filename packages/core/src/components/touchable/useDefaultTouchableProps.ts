...
import { TouchablePropsBase } from './TouchableProps';

export const useDefaultTouchableProps = <
  Props extends TouchablePropsBase<Props, Theme>,
  Theme
>(
  props: Partial<Props>,
  theme: Theme,
  ...
  const touchableProps: TouchablePropsBase<Props, Theme> = {
    ...props,
    activated,
    disabled,
    interactionState,
   ...
   */
  // @ts-ignore Type 'TouchablePropsBase<Props, Theme>'
