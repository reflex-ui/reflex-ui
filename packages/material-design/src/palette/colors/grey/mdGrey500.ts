  ...
  color: {
    inverted: {
      ...
      uncontained: createPaletteColorInteraction({
        color: createPaletteColorUsingOnColorOnly(grey500),
    ...
    regular: {
      ...
      uncontained: createPaletteColorInteraction({
        color: createPaletteColorUsingColorOnly(grey500),
        colorVariantFactory: createUncontainedPaletteColorVariant,
