...
const XLargeListIconTwoLinesScreen: React.SFC = (): JSX.Element => (
  <Screen>
    <AppBar>
...
XLargeListIconTwoLinesScreen.displayName = 'XLargeListIconTwoLinesScreen';

export { XLargeListIconTwoLinesScreen };
