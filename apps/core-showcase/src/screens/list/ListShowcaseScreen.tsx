              ...
              <React.Fragment>
                <Column margin={Size.L} marginBottom={0}>
                  ...
                  <Paragraph1 marginTop={Size.XL}>
                    We also pass {'maxWidth={listMaxWidth}'} to all lists in
                    this screen.
                    {'\n'}
                  ...
                  <Paragraph1 marginTop={Size.M}>
                    That means we limit its size to 360 for large screens, and
                    let it grows to the size of its container for small screens.
                  </Paragraph1>
                </Column>
                ...
                <List maxWidth={listMaxWidth} paletteColor={palette.surface}>
                  <TouchableSurface
                    activated
                    contained={false}
                  ...
                  <TouchableSurface contained={false} onPress={onListItemPress}>
                    <ListItem size={Size.XXS}>
                      <Paragraph2 marginHorizontal={Size.S}>
                        Important
                      </Paragraph2>
                    </ListItem>
                  </TouchableSurface>
                    ...
                    <ListItem size={Size.L}>
                      <Column flexShrink={1} marginHorizontal={Size.S}>
                        ...
                        <Paragraph2 numberOfLines={1}>
                          Trevor Hansen -
                          <Paragraph2>
                            Have any ideas about what we should get Heidi for
                            her birthday?
                          </Paragraph2>
                        </Paragraph2>
                      </Column>
