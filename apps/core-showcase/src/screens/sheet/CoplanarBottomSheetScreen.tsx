...
const onButtonPress = () => {
  ...
  console.log('CoplanarBottomSheetScreen().onButtonPress()');
};

const CoplanarBottomSheetScreen: React.SFC<{}> = (): JSX.Element => {
    ...
    <Screen>
      ...
      <ScrollView>
        <Column paddingHorizontal={Size.M} paddingVertical={60}>
          <Headline2>CoplanarSheet: Bottom</Headline2>
          ...
          <Row paletteColor={palette.primary}>
            ...
            <Button
              ...
              variant={ButtonVariant.Outlined}
            >
              Coplanar Bottom Sheet (scrolling)
            </Button>
          </Row>
          <Paragraph1 marginVertical={Size.M}>
      ...
      <MyTopBottomSheet
        ...
        onClose={() => closeSheet()}
        paddingStart={Size.M}
        variant={CoplanarSheetVariant.Bottom}
      />
    </Screen>
  );
};

CoplanarBottomSheetScreen.displayName = 'CoplanarBottomSheetScreen';

export { CoplanarBottomSheetScreen };
