  ...
  <Router history={navigator}>
    <Switch>
      ...
      <Route
        ...
        component={CoplanarEndSheetScreen}
      />
      <Route
        exact
        path="/sheet/coplanar-start-sheet"
        component={CoplanarStartSheetScreen}
      />
      <Route
        exact
        path="/sheet/modal-dialog-sheet"
        component={ModalDialogSheetScreen}
      />
      <Route
        exact
